...
import walkthroughPoster from './assets/aca-computer-walkthrough-poster.webp'
import './getting-started.css'

const walkthroughVideo = new URL('./assets/aca-computer-walkthrough.mp4', import.meta.url).href
const walkthroughCaptions = new URL('./assets/aca-computer-walkthrough.vtt', import.meta.url).href
...
export function GettingStarted({ onBack, onContinue }: { onBack: () => void; onContinue?: () => void }) {
  ...
  return <main className="portal-main setup-guide">
    ...
    {!phone && <section id="watch" className="setup-watch" aria-labelledby="setup-watch-title"><h2 id="setup-watch-title">Watch</h2><p>Getting started on a computer. Pause or replay whenever you like.</p><video controls playsInline preload="metadata" poster={walkthroughPoster} width={1280} height={720} aria-label="Getting Started with ChatGPT: computer walkthrough"><source src={walkthroughVideo} type="video/mp4" /><track kind="captions" src={walkthroughCaptions} srcLang="en" label="English" default />Your browser does not support video playback.</video></section>}
